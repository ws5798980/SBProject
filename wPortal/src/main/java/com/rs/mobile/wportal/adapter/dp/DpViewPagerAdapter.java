...
public class DpViewPagerAdapter extends PagerAdapter {
	...
	public DpViewPagerAdapter(Context context, JSONObject json) {
	...
	public DpViewPagerAdapter(Context context, JSONObject json, float ratio) {
		// TODO Auto-generated constructor stub
		this.context = context;
		try {
			this.arr = json.getJSONArray("adInfo");
