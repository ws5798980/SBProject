...
public class AutoLabelUISettings implements Parcelable {
    ...
    public static final int DEFAULT_ICON_CROSS              = android.R.drawable.ic_delete;
    ...
    public static final class Builder {
        ...
        private int bTextColor              = R.color.textColor_rt_toolbar_title;
        private int bTextSize               = R.dimen.text_size_m;
        private int bLabelPadding           = R.dimen.marginx2;
        private int bBackgroundResource     = android.R.color.white;
