...
import com.rs.mobile.wportal.adapter.dp.LogistaticsAdapter;
...
public class DpLogisticsActivity extends BaseActivity {
	...
	private void initView() {
		...
		rela_call.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// TODO Auto-generated method stub
				PageUtil.callDial(DpLogisticsActivity.this, phone);
			}
		});
	}
	...
	private void initData() {
		...
		OkHttpHelper okHttpHelper = new OkHttpHelper(DpLogisticsActivity.this);
		...
		}, Constant.BASE_URL_DP1 + Constant.GET_GOODSEXPRESSOF_LIST, params);
	}
	...
	private void jsonParsing(JSONObject data) {
		...
		try {
			...
			listView.setAdapter(new LogistaticsAdapter(jsonArray, DpLogisticsActivity.this));
