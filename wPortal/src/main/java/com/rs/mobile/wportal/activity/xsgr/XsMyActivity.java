...
//                }
            ...
            case R.id.text_to_myshop:
                UtilClear.CheckLogin(XsMyActivity.this, new UtilCheckLogin.CheckListener() {
                    ...
                    @Override
                    public void onDoNext() {
//                        String realUrl="http://www."+(AppConfig.CHOOSE.equals("CN")?"gigawon.cn":"gigawon.co.kr")+":1314/80_StoreAdmin/storeMain.aspx?custom_code="+S.get(XsMyActivity.this, C.KEY_JSON_CUSTOM_CODE)+"&sale_custom_code=01071390009abcde&token="+S.get(XsMyActivity.this, C.KEY_JSON_TOKEN);
