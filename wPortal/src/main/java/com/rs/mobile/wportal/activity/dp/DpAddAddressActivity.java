...
public class DpAddAddressActivity extends BaseActivity {
	...
	private EditText editText_receiver, editText_phone, editText_address;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			setContentView(com.rs.mobile.wportal.R.layout.activity_sm_add_address);
	...
	private void initData() {
		...
		try {
			...
			title_text_view.setText(getResources().getString(com.rs.mobile.wportal.R.string.change_address));
	...
	private void initView() {
		...
		try {
			...
			editText_receiver = (EditText) findViewById(com.rs.mobile.wportal.R.id.editText_receiver);

			editText_phone = (EditText) findViewById(com.rs.mobile.wportal.R.id.editText_phone);

			address_pop = (LinearLayout) findViewById(com.rs.mobile.wportal.R.id.address_pop);

//			text_next = (TextView) findViewById(com.rs.mobile.wportal.R.id.text_next);

			editText_address = (EditText) findViewById(com.rs.mobile.wportal.R.id.editText_address);
...
//			rela_004 = (RelativeLayout) findViewById(com.rs.mobile.wportal.R.id.rela_004);
			...
			rela_003 = (RelativeLayout) findViewById(com.rs.mobile.wportal.R.id.rela_003);
			...
			linear_gone = (LinearLayout) findViewById(com.rs.mobile.wportal.R.id.linear_gone);
			...
			show001 = (TextView) findViewById(com.rs.mobile.wportal.R.id.TextView_city_show001);

			show002 = (TextView) findViewById(com.rs.mobile.wportal.R.id.TextView_city_show002);

			show003 = (TextView) findViewById(com.rs.mobile.wportal.R.id.TextView_city_show003);

			listview_ProvinceName = (ListView) findViewById(com.rs.mobile.wportal.R.id.ListView_city001);

			listview_city = (ListView) findViewById(com.rs.mobile.wportal.R.id.ListView_city002);

			listview_area = (ListView) findViewById(com.rs.mobile.wportal.R.id.ListView_city003);
				...
				public void onClick(View v) {
					...
					try {
						...
						if (username.equals("") && address.equals("") && mobile.equals("")) {
							...
							t(getResources().getString(com.rs.mobile.wportal.R.string.plz_fill_text));
							...
							if (zipCode == null || zipCode.equals("") || zipCode.equals("null")
								...
								if (activity.equals("edit")) {
									...
									postEdit(Constant.BASE_URL_DP1 + Constant.UPDATE_USER_SHOPADDRESS);

								} else {

									postEdit(Constant.BASE_URL_DP1 + Constant.ADD_USERSHOP_ADDRESS);
	...
	public void postEdit(final String url) {
		...
		try {
			...
			Util.getGeocodesByAddress(DpAddAddressActivity.this, "JSON",
					text_next.getText().toString().replace(" ", "") + editText_address.getText().toString(),
					new Util.GeocodesByAddressListener() {
						...
						public void onError() {
							...
							t(getString(com.rs.mobile.wportal.R.string.dp_text_033));
						...
						public void onComplete(String json) {
							...
							try {
								...
								params.put(C.KEY_JSON_TOKEN,
										S.getShare(DpAddAddressActivity.this, C.KEY_JSON_TOKEN, ""));
								...
								OkHttpHelper okHttpHelper = new OkHttpHelper(DpAddAddressActivity.this);
	...
	public void getZipCode(final boolean fromSave) {
		...
		try {
			...
			OkHttpHelper okhttp = new OkHttpHelper(DpAddAddressActivity.this);
