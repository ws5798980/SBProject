...
import com.rs.mobile.wportal.activity.dp.DpFillinLogicActivity;
import com.rs.mobile.wportal.activity.dp.DpReturnProcessActivity;
...
public class DpReturnGoodsListAdapter extends BaseAdapter {
	...
	public DpReturnGoodsListAdapter(JSONArray arr, Context context) {
		super();
		this.arr = arr;
		...
		try {
			...
			text_btn2.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					PageUtil.jumpTo(context, DpFillinLogicActivity.class, bundle);
			...
			text_btn3.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					Bundle bundle = new Bundle();
					bundle.putString("refundNo", refundNo);
					PageUtil.jumpTo(context, DpReturnProcessActivity.class, bundle);
				}
			});
		} catch (Exception e) {
