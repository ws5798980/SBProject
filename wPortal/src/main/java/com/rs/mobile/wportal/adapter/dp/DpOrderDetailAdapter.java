...
public class DpOrderDetailAdapter extends BaseAdapter {
	...
	public DpOrderDetailAdapter(JSONArray listdata, Context context, String order_code, String ONLINE_ORDER_STATUS) {
