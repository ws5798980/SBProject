...
public class PersnalReference_Detail2 extends Activity {

    private TextView tv_gubun, tv_names, tv_telphone;

    private TextView tv_Agree_btn, tv_Cancel_btn, tv_close_btn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_persnal_reference__detail2);
