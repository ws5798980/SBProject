...
public class DpAboutUsActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		textView.setText(getResources().getString(com.rs.mobile.wportal.R.string.app_name) +"v"+ getVersionCode(DpAboutUsActivity.this) + "");
