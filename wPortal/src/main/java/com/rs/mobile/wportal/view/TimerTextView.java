...
//		time.append(detail_text);
//		time.append(getResources().getString(com.rs.mobile.wportal.R.string.common_text120) + minute);
//		time.append(getResources().getString(com.rs.mobile.wportal.R.string.common_text121));
//		time.append(second);
//		time.append(getResources().getString(com.rs.mobile.wportal.R.string.common_text122) + ")");
		time.append("결제하기" + minute + "분" + second + "초");
	 ...
	 * 开始计时
	 */
	public void start(OnTimerOverListener onTimerOverListener) {
