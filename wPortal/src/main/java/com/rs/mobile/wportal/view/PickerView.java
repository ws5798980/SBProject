...
public class PickerView extends View {
	...
	private List<String> dataBack;// 后台的原始数据
	/**
	...
	private void drawData(Canvas canvas) {
		...
		mPaint.setTextSize((float) (size / 1.5));
		mPaint.setColor(ContextCompat.getColor(getContext(), com.rs.mobile.wportal.R.color.inputblack));
	...
	public interface onSelectListener {
		void onSelect(String text, int d);
	}
}