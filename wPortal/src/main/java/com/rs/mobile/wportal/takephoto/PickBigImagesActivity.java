...
public class PickBigImagesActivity extends BaseActivity implements ViewPager.OnPageChangeListener, View.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.rs.mobile.wportal.R.layout.activity_pick_big_images);
        initFindView();
        initData();
    }

    protected void initFindView() {
        viewPager = (ViewPager) findViewById(com.rs.mobile.wportal.R.id.vp_content);
        tv_choose_pic = (TextView) findViewById(com.rs.mobile.wportal.R.id.tv_choose_pic);
        iv_choose_state = (ImageView) findViewById(com.rs.mobile.wportal.R.id.iv_choose_state);
        tv_choose_pic.setOnClickListener(this);
        iv_choose_state.setOnClickListener(this);


        findViewById(com.rs.mobile.wportal.R.id.iv_back).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btn_choose_finish = (Button) findViewById(com.rs.mobile.wportal.R.id.btn_choose_finish);
        ...
        if(last_pics < total_pics) {
            btn_choose_finish.setTextColor(getResources().getColor(com.rs.mobile.wportal.R.color.white));
            btn_choose_finish.setText(String.format(getString(com.rs.mobile.wportal.R.string.choose_pic_finish_with_num), total_pics - last_pics, total_pics));
        }
    }
    ...
    protected void initData() {
        ...
        if (getChooseStateFromList(currentPic)){
            iv_choose_state.setBackgroundResource(com.rs.mobile.wportal.R.drawable.image_choose);
        }else{
            iv_choose_state.setBackgroundResource(com.rs.mobile.wportal.R.drawable.image_not_chose);
        }
    ...
    public void onPageSelected(int position) {
        ...
        currentPic = position;
        ((TextView)findViewById(com.rs.mobile.wportal.R.id.tv_title)).setText((currentPic + 1) + "/" + getImagesCount());
    }
    ...
    public void onClick(View view) {
        ...
        if(getChooseStateFromList(currentPic)){
            if (last_pics <= 0){
                toggleChooseState(currentPic);
                Toast.makeText(this, String.format(getString(com.rs.mobile.wportal.R.string.choose_pic_num_out_of_index), total_pics), Toast.LENGTH_SHORT).show();
                return ;
            }
            ...
            iv_choose_state.setBackgroundResource(com.rs.mobile.wportal.R.drawable.image_not_chose);
            if(last_pics == total_pics){
                btn_choose_finish.setTextColor(getResources().getColor(com.rs.mobile.wportal.R.color.found_description_color));
                btn_choose_finish.setText(getString(com.rs.mobile.wportal.R.string.choose_pic_finish));
            }else{
                btn_choose_finish.setText(String.format(getString(com.rs.mobile.wportal.R.string.choose_pic_finish_with_num), total_pics-last_pics, total_pics));
            }
        }
    ...
    private class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            View view = LayoutInflater.from(PickBigImagesActivity.this).inflate(com.rs.mobile.wportal.R.layout.widget_zoom_iamge, null);
            final ZoomImageView zoomImageView = (ZoomImageView) view.findViewById(com.rs.mobile.wportal.R.id.zoom_image_view);
