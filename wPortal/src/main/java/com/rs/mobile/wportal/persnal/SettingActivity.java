            ...
            try {
                ...
                if (info != null) {
                    ...
                    ((TextView)findViewById(R.id.app_ver_text_view)).setText(getResources().getString(R.string.o2o) +
                            "Version : v" + info.versionName + "(" + (C.BASE_URL.contains("portal."+(AppConfig.CHOOSE.equals("CN")?"gigaosung.cn":"gigaosung.com"))? "P":"D") + ")");
...
//													T.showToast(SettingActivity.this, data.getString("msg"));
                                        ...
                                        }, "http://api1."+(AppConfig.CHOOSE.equals("CN")?"gigawon.cn":"gigawon.co.kr")+":8088" + Constant.SSO_LOGOUT, headers, obj.toString());
...
//						Uri uri = Uri.parse(imageDownloadUrl);
            ...
            }, "http://member."+(AppConfig.CHOOSE.equals("CN")?"gigawon.cn":"gigawon.co.kr")+":8808/api/member/requestProfileInfo", params);
...
//			headers.put("Content-Type", "application/json;Charset=UTF-8");
            ...
            }, "http://member."+(AppConfig.CHOOSE.equals("CN")?"gigawon.cn":"gigawon.co.kr")+":8808/api/member/editProfile", j1.toString());
