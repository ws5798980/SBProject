...
public class PullToRefreshScrollView extends PullToRefreshBase<ObservableScrollView> {
	  ...
	  private PullScroolListener pullScroolListener = null;  
	...
	protected ObservableScrollView createRefreshableView(Context context, AttributeSet attrs) {
		...
		scrollView.setScrollViewListener(new ScrollViewListener() {
			...
			public void onScrollChanged(ObservableScrollView scrollView, int x, int y,
					int oldx, int oldy) {
				 if (pullScroolListener != null) {  
					 pullScroolListener.onScrollType(x, y);
			        }  
			}
		});
		return scrollView;
	...
	//===============
	  ...
	  public void setPullScroolListener(PullScroolListener pullScroolListener) {  
	        this.pullScroolListener = pullScroolListener;  
	    } 
	 
    public interface PullScroolListener {  
  
        void onScrollType( int x, int y);  
