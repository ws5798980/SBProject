...
public class Register4Activity extends AppCompatActivity {
    ...
    private EditText etText1, etText2, etText3, etText4, etText5, etText6, etText7, etText8, etText9;
    ...
    private void register(){
        ...
        params.put("comp_class", (String)etText8.getText().toString());
        params.put("comp_type", etText9.getText().toString());
        ...
        OkHttpHelper okHttpHelper = new OkHttpHelper(Register4Activity.this);
        okHttpHelper.addPostRequest(new OkHttpHelper.CallbackLogic() {
            ...
            public void onBizSuccess(String responseDescription, JSONObject data, String flag) {
                ...
                if("1".equals(entity.status)){
                    Toast.makeText(Register4Activity.this, entity.msg, Toast.LENGTH_LONG).show();
                    finish();
                }else{
                    Toast.makeText(Register4Activity.this, entity.msg, Toast.LENGTH_LONG).show();
                }
