    ...
    private void selfInit() {
        if (mDraweeHolder == null) {
            final GenericDraweeHierarchy hierarchy = new GenericDraweeHierarchyBuilder(getResources())
                    .setProgressBarImage(new AutoRotateDrawable(getResources().getDrawable(com.rs.mobile.common.R.drawable.img_loading), 700), ScalingUtils.ScaleType.CENTER).build();
