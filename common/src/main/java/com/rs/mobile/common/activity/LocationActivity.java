				...
				borough_list_view.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> adapter, View view, int position, long id) {
						...
						try {
							...
							WListAdapter wAdapter = new WListAdapter(LocationActivity.this, 
				...
				affiliste_list_view.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> adapter, View view, int position, long id) {
						...
						try {
							...
							result.putExtra("divCode", obj.getString("divCode"));
							
							result.putExtra("divName", obj.getString("divName"));
				...
				helper.addPostRequest(new OkHttpHelper.CallbackLogic() {
					...
					public void onBizSuccess(String responseDescription, final JSONObject data, final String all_data) {
						...
						try {
							...
							GridListAdapter adapter = new GridListAdapter(LocationActivity.this, arr);
			...
			helper.addPostRequest(new OkHttpHelper.CallbackLogic() {
				...
				public void onBizSuccess(String responseDescription, final JSONObject data, final String all_data) {
					...
					try {
						...
						boroughAdapter = new WListAdapter(LocationActivity.this, areaAndSquare, WListAdapter.TYPE_BOROUGH);
						
						borough_list_view.setAdapter(boroughAdapter);
						
						WListAdapter affilisteListAdapter = new WListAdapter(LocationActivity.this, areaAndSquare.getJSONObject(0).getJSONArray("squareList"), WListAdapter.TYPE_AFFILIATE);
