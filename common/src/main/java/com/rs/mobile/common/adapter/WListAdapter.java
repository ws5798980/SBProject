		...
		try {
			...
			if (convertView == null) {
				...
				if (type == TYPE_AFFILIATE) {
					...
					convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_affiliate, parent, false);
				
				} else if (type == TYPE_BOROUGH) {
					
					convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_borough, parent, false);
